...
namespace WebPatter.WebUI.Models
{
    ...
    public class SetEmailViewModel
    {
        ...
        [DataType(DataType.EmailAddress)]
        [Display(Name = "Подтверждение адреса")]
        [Compare("NewPassword", ErrorMessage = "Адреса не совпадают.")]
    ...
    public class ChangeEmailViewModel
    {
        ...
        [DataType(DataType.EmailAddress)]
        [Display(Name = "Подтверждение нового адреса")]
        [Compare("NewPassword", ErrorMessage = "Адреса не совпадают.")]
        public string ConfirmEmail { get; set; }
    }
